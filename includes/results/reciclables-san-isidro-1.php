...
<div class="result-wrapper">
    <div class="result-item plastico">
            ...
            <ul>
                <li class="result-where-item">
                    <a href="#">
                        ...
                        <hgroup>
                            <h4>Contenedores Amarillos</h4>
                            <p>En los contenedores amarillos, todos los días, las 24hs.</p>
                        </hgroup>
                    </a>
                </li>
            </ul>
        ...
        <div class="result-block result-why">
            <h4>Representa el <span>16%</span> de tus residuos</h4>
            <a href="#" class="btn btn-link">Más informaci&oacute;n</a>
        </div>
    </div>
</div>