...
<div class="result-wrapper">
    <div class="result-item">
        ...
        <div class="result-block result-where">
            ...
            <ul>
                <li class="result-where-item">
                    <a href="#">
                        <span class="result-where-item-icon"><i class="fa fa-trash"></i></span>
                        <hgroup>
                            <h4>Contenedores Verdes</h4>
                            <p>En los contenedores verdes de lunes a viernes de 20 a 21hs.</p>
                        </hgroup>
                    </a>
                </li>
                ...
                <li class="result-where-item">
                    <a href="#">
                        <span class="result-where-item-icon"><i class="fa fa-building"></i></span>
                        <hgroup>
                            <h4>En tu edificio</h4>
                            <p>Si vivís en edificio, enterate cómo organizar la separación acá.</p>
                        </hgroup>
                    </a>
                </li>
        ...
        <div class="result-block result-why">
            <h4>Representa el <span>40%</span> de tus residuos</h4>
            <a href="#" class="btn btn-link">Más informaci&oacute;n</a>
        </div>
    </div>
</div>