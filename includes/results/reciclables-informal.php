...
<div class="result-wrapper">
 ...
 -->    <div class="result-item carton-y-papel">
        ...
        <div class="result-block result-where">
            ...
            <ul>
                <li class="result-where-item">
                    <a href="#">
                        <span class="result-where-item-icon"><i class="fa fa-male"></i></span>
                        <hgroup>
                            <h4>Recuperador Informal</h4>
                            <p>Coordiná con el <em>recuperador informal</em> de tu cuadra y depositalos limpios y secos en tu vereda.</p>
                        </hgroup>
                    </a>
                </li>
        ...
        <div class="result-block result-why">
            <h4>Representa el <span>14%</span> de tus residuos</h4>
            <a href="#" class="btn btn-link">Más informaci&oacute;n</a>
        </div>
    </div>
</div>